...
module AgentVendSdk
  ...
  class AgentVendClient
    ...
    def initialize(
      ...
      @api_url = (api_url || ENV["AGENTVEND_API_URL"] || DEFAULT_API_URL).to_s.sub(%r{/\z}, "")
      ...
      @service_id = (service_id || ENV["AGENTVEND_SERVICE_ID"] || ENV["AGENTVEND_AGENT_ID"]).to_s
      @service_secret = (service_secret || ENV["AGENTVEND_SERVICE_SECRET"] || ENV["AGENTVEND_AGENT_SECRET"]).to_s
    ...
    def validate_service_key(service_key)
      ...
      raw = res.body.to_s
      return nil unless AgentVendSdk.validate_hmac_signature(sig, raw + ts, @service_secret)
    ...
    def report_usage_at(user_id, service_id, units_used, timestamp = nil)
      ...
      sig = AgentVendSdk.calculate_hmac_with_timestamp(body, header_ts, @service_secret)
    ...
    def send_progress_update(progress_url, request_id, stage, percentage_complete, error_message = nil)
      ...
      body = JSON.generate(body_hash)
      sig = AgentVendSdk.calculate_hmac_with_timestamp(body, ts, @service_secret)
