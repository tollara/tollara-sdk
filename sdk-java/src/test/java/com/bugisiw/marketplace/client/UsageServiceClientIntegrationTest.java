...
/**
 * Integration tests for UsageServiceClient against WireMock stubs of the Agent Hub Usage API
    ...
    void reportUsage_sendsSignedRequest_andReturnsResponse() {
        wireMock.stubFor(
                post(urlPathEqualTo("/api/usage/report"))
                        ...
                        .withHeader("X-Marketplace-Signature", matching(".+"))
                        .withHeader("X-Marketplace-Timestamp", matching("\\d+"))
    ...
    void sendProgressUpdate_postsToProgressUrlWithSignature() {
        ...
        wireMock.stubFor(
                post(urlPathEqualTo(progressPath))
                        .withHeader("X-Marketplace-Signature", matching(".+"))
                        .withHeader("X-Marketplace-Timestamp", equalTo(timestamp))
