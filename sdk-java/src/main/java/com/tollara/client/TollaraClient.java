...
/**
 * Single entry point for Tollara HTTP APIs (Core validate and estimates, Usage report/progress/complete, Gateway
 * invoke and polling).
 * <p>
...
public final class TollaraClient {
    ...
    private TollaraClient(Builder b) {
        String resolved = firstNonBlank(b.apiUrl, System.getenv(ENV_API_URL));
        resolved = TollaraUrls.trimTrailingSlashes(resolved);
        if (resolved.isEmpty()) {
            resolved = DEFAULT_API_URL;
        }

        String coreBase = TollaraUrls.trimTrailingSlashes(firstNonBlank(b.coreApiUrl, resolved));
    ...
    public GatewayInvokeResult invokeService(
        ...
        try {
            ...
            throw new TollaraHttpException("Gateway invoke failed: " + e.getMessage(), e);
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
            throw new TollaraHttpException("Gateway invoke interrupted", e);
        }
    }
    ...
    public static final class Builder {
        ...
        /**
         * Explicit API origin (overrides {@value TollaraClient#ENV_API_URL}). When omitted and env is unset, {@value TollaraClient#DEFAULT_API_URL} is used.
         */
        ...
        /**
         * Service UUID (overrides {@value TollaraClient#ENV_SERVICE_ID}).
        ...
        /**
         * Shared secret (overrides {@value TollaraClient#ENV_SERVICE_SECRET}).
        ...
        public TollaraClient build() {
            return new TollaraClient(this);
        }
    }
}
